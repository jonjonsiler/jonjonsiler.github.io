...
export default function Post({ post }: { post: PostProps }) {
  ...
  return (
    <article className="surface-card space-y-5 rounded-3xl border border-slate-800/70 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-sky-400/60 hover:shadow-sky-500/20 md:p-8">
      <a href={detailUrl} className="group block space-y-5 rounded-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/80">
        ...
        <span className="inline-flex items-center text-sm font-semibold uppercase tracking-[0.35em] text-sky-300 transition-colors duration-200 group-hover:text-white">
          Read article →
        </span>
      </a>
    </article>
