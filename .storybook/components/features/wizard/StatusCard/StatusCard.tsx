...
import { MasteryChangeIndicator } from '@components/features/planner/MasteryChangeIndicator/MasteryChangeIndicator';

// Import all SVG files
import noDataGraph from '@components/features/planner/MasteryChangeGraphs/NoDataGraphs/noDataGraph.svg';

// NotDeveloped (red) graphs
import redNoDataNotDeveloped from '@components/features/planner/MasteryChangeGraphs/NotDevelopedGraphs/red-noData-notDeveloped.svg';
import redNotDevelopedNotDeveloped from '@components/features/planner/MasteryChangeGraphs/NotDevelopedGraphs/red-notDeveloped-notDeveloped.svg';
import redDevelopingNotDeveloped from '@components/features/planner/MasteryChangeGraphs/NotDevelopedGraphs/red-devloping-notDeveloped.svg';
import redLikelyMasteredNotDeveloped from '@components/features/planner/MasteryChangeGraphs/NotDevelopedGraphs/red-likleyMastered-notDeveloped.svg';

// Developing (yellow) graphs
import yellowNotDevelopedDeveloping from '@components/features/planner/MasteryChangeGraphs/DevelopingGraphs/yellow-notDeveloped-developing.svg';
import yellowDevelopingDeveloping from '@components/features/planner/MasteryChangeGraphs/DevelopingGraphs/yellow-developing-developing.svg';
import yellowLikelyMasteredDeveloping from '@components/features/planner/MasteryChangeGraphs/DevelopingGraphs/yellow-likelyMastered-developing.svg';
import yellowNoDataDeveloping from '@components/features/planner/MasteryChangeGraphs/DevelopingGraphs/yellow-noData-developing.svg';

// LikelyMastered (green) graphs
import greenDevelopingLikelyMastered from '@components/features/planner/MasteryChangeGraphs/LikelyMasteredGraphs/green-developing-likelyMastered.svg';
import greenLikelyMasteredLikelyMastered from '@components/features/planner/MasteryChangeGraphs/LikelyMasteredGraphs/green-likelyMastered-likelyMastered.svg';
import greenNoDataLikelyMastered from '@components/features/planner/MasteryChangeGraphs/LikelyMasteredGraphs/green-noData-likelyMastered.svg';
import greenNotDevelopedLikelyMastered from '@components/features/planner/MasteryChangeGraphs/LikelyMasteredGraphs/green-notDeveloped-likelyMastered.svg';
